...
def create_parser():
    ...
    parser.add_argument('--type_graph', type=str, default="TREE", dest="type_graph", help="Type of graph to use")
    ...
    parser.add_argument('--path_contacts', type=str, default="contacts.npz", dest="path_contacts", help="path real data contacts")
